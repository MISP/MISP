    			...
    			<td class="actions">
    				<?php
    				    if ($isAclModify) {
    				    	...
    				    	echo $this->Html->link(__('Edit', true), array('controller' => 'events', 'action' => 'view', $event['Event']['id']), array('id' =>$button_modify_status.$buttonCounter++,'class' => $button_modify_status));
