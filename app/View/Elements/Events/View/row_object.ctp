...
<tr id = "Object_<?php echo $object['id']; ?>_tr" class="<?php echo $tr_class; ?>" tabindex="0">
  ...
  <td class="short action-links">
    ...
    ?>
        ...
        <span class="icon-trash icon-white useCursorPointer" title="<?php echo __('Delete object');?>" role="button" tabindex="0" aria-label="<?php echo __('Delete attribute');?>" onClick="deleteObject('objects', 'delete', '<?php echo h($object['id']); ?>', '<?php echo h($event['Event']['id']); ?>');"></span>
    <?php
      elseif ($mayModify):
    ?>
        <span class="icon-trash icon-white useCursorPointer" title="<?php echo __('Delete object');?>" role="button" tabindex="0" aria-label="<?php echo __('Delete attribute');?>" onClick="deleteObject('objects', 'delete', '<?php echo h($object['id']) . '/true'; ?>', '<?php echo h($event['Event']['id']); ?>');"></span>
    <?php
      endif;
    ?>
  </td>
