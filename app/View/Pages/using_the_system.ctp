...
The process of entering an event can be split into 3 phases, the creation of the event itself, populating it with attributes and attachments and finally publishing it.<br /><br />
	...
	<ul>
		<li style="list-style-type:none"><p><img src="/img/doc/add_event.png" alt="Add Event" style="float:right;" title = "Fill this form out to create a skeleton event, before proceeding to populate it with attributes and attachments."/></p><br /></li>
		...
		<li style="list-style-type:none"><ul>
			<li><i>Org:</i> This setting will only allow members of your organisation on your server to see it.<br /><br /></li>
			<li><i>Community:</i> Users that are part of your MISP community will be able to see the event. This includes your own organisation, organisations on your MISP server and organisations running MISP servers that synchronise with your server. Any other organisations connected to such linked servers will be restricted from seeing the event.<br /><br /></li>
			<li><i>All:</i> This will share the event with all trusted MISP communities, meaning all the members of every community that is connected to your server.<br /><br /></li>
		</ul></li>
...
<ul>
	<li style="list-style-type:none"><p><img src="/img/doc/add_attribute.png" alt="Add Attribute" style="float:right;" title = "This form allows you to add attributes."/></p><br /></li>
...
<img src="/img/doc/list_events2.png" alt="Events" title = "This is the list of events in the system. Use the buttons to the right to alter or view any of the events."/><br /><br />
	<ul>
...
<h3>Listing all attributes:</h3>
	...
	<img src="/img/doc/list_attributes2.png" alt="Attributes" title = "Use the buttons to the right to view the event that this attribute belongs to or to modify/delete the attribute."/><br /><br />
	<ul>
...
<img src="/img/doc/search_attribute.png" alt="Search attributes" title = "You can search for attributes by searching for a phrase contained in its value. Narrow your search down by selecting a type and/or a category which the event has to belong to."/><br /><br />
...
<br /><img src="/img/doc/search_attribute_result.png" alt="Search attributes result" title = "You can view the event that an attribute belongs to with the view button, or you can edit/delete the attribute via the buttons on the right."/><br />
<br /><hr /><br />
...
<br /><img src="/img/doc/edit_event.png" alt="Edit event" title = "Just alter any of the fields and click submit to change the event."/><br />
 <br /><hr /><br />
...
<br /><img src="/img/doc/contact_reporter.png" alt="Contact reporter" title = "Enter your message to the reporter and choose whether his/her entire organisation should get the message or not by ticking the check-box."/><br /><br />
