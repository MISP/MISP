				...
				foreach ($newsItems as $newsItem): ?>
					<div class="templateTableRow" style="width:800px;">
						...
						<div style="padding:6px;">
							...
							<?php
									echo $this->Form->postLink('', array('action' => 'delete', $newsItem['News']['id']), array('class' => 'icon-trash', 'title' => 'Delete'), __('Are you sure you want to delete news item # {0}?', $newsItem['News']['id']));
								endif;
							?>
						</div>
					</div>
