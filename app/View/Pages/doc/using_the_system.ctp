<div class="actions <?php echo $debugMode;?>">
	<ol class="nav flex-column">
			...
			<li class="nav-item"><?php echo $this->Html->link(__('User Management and Global actions'), array('controller' => 'pages', 'action' => 'display', 'doc', 'user_management'), array('class' => 'nav-link')); ?></li>
			<li class="active"><?php echo $this->Html->link(__('Using the system'), array('controller' => 'pages', 'action' => 'display', 'doc', 'using_the_system'), array('class' => 'nav-link')); ?>
			<ul class="nav flex-column">
				<li class="nav-item"><a class="nav-link" href="#create"><?php echo __('Creating an event');?></a></li>
				<li class="nav-item"><a class="nav-link" href="#browsing_events"><?php echo __('Browsing past events');?></a></li>
				<li class="nav-item"><a class="nav-link" href="#update_events"><?php echo __('Updating and modifying events');?></a></li>
				<li class="nav-item"><a class="nav-link" href="#contact"><?php echo __('Contacting the publisher');?></a></li>
				<li class="nav-item"><a class="nav-link" href="#tagging"><?php echo __('Tagging');?></a></li>
				<li class="nav-item"><a class="nav-link" href="#templating"><?php echo __('Templating');?></a></li>
				<li class="nav-item"><a class="nav-link" href="#automation"><?php echo __('Automation');?></a></li>
				<li class="nav-item"><a class="nav-link" href="#export"><?php echo __('Exporting data');?></a></li>
				<li class="nav-item"><a class="nav-link" href="#connect"><?php echo __('Connecting to other servers');?></a></li>
				<li class="nav-item"><a class="nav-link" href="#rest"><?php echo __('Rest API');?></a></li>
			</ul>
		</li>
...
and attachments and finally publishing it.');?><br /><br />
	...
	<ul>
		<li class="nav-item"><b><?php echo __('Date');?>:</b> <?php echo __('The date when the incident has happened. Just click this field and a date-picker will pop up where you can select the desired date.');?></li>
		<li class="nav-item"><b><?php echo __('Distribution');?>:</b>
		...
		<li style="list-style: none;">
			<ul>
			<li class="nav-item"><i><?php echo __('Your organization only');?>:</i> <?php echo __('This setting will only allow members of your organisation to see this. It can be pulled to another instance by one of your organisation members where only your organisation will be able to see it.
							Events with this setting will not be synchronised');?>.<br />
				<?php echo __('Upon push: do not push. Upon pull : pull.');?>
				</li>
			<li class="nav-item"><i><?php echo __('This Community-only');?>:</i> <?php echo __('Users that are part of your MISP community will be able to see the event.
			...
			<li class="nav-item"><i><?php echo __('Connected communities');?>:</i> <?php echo __('Users that are part of your MISP community will be able to see the event.
			...
			<li class="nav-item"><i><?php echo __('All communities');?>:</i> <?php echo __('This will share the event with all MISP communities, allowing the event to be
							freely propagated from one server to the next.');?><br/>
				<?php echo __('Upon push: push. Upon pull: pull.');?>
				</li>
			</ul>
		</li>
		<li class="nav-item"><b><?php echo __('Threat Level');?>:</b> <?php echo __('This field indicates the risk level of the event. Incidents can be categorised into three different threat categories (low, medium, high). This field can alternatively be left as undefined. The 3 options are');?>:</li>
		<li style="list-style: none;"><ul>
			<li class="nav-item"><i><?php echo __('Low');?>:</i> <?php echo __('General mass malware.');?></li>
			<li class="nav-item"><i><?php echo __('Medium');?>:</i> <?php echo __('Advanced Persistent Threats (APT)');?></li>
			<li class="nav-item"><i><?php echo __('High');?>:</i> <?php echo __('Sophisticated APTs and 0day attacks.');?></li>
		</ul></li>
		<li class="nav-item"><b><?php echo __('Analysis');?>:</b> <?php echo __('Indicates the current stage of the analysis for the event, with the following possible options');?>:</li>
		<li style="list-style: none;"><ul>
			<li class="nav-item"><i><?php echo __('Initial');?>:</i> <?php echo __('The analysis is just beginning');?></li>
			<li class="nav-item"><i><?php echo __('Ongoing');?>:</i> <?php echo __('The analysis is in progress');?></li>
			<li class="nav-item"><i><?php echo __('Completed');?>:</i> <?php echo __('The analysis is complete');?></li>
		</ul></li>
		<li class="nav-item"><b><?php echo __('Event Description');?>:</b> <?php echo __('The info field, where the malware/incident can get a brief description starting with the internal reference. This field should be as brief and concise as possible, the more detailed description happens through attributes in the next stage of the event\'s creation. Keep in mind that the system will automatically replace detected text strings that match a regular expression entry set up by your server\'s administrator(s).');?></li>
		<li class="nav-item"><b><?php echo __('GFI Sandbox');?>:</b> <?php echo __('It is possible to upload the exported .zip file from GFI sandbox with the help of this tool. These will be dissected by the MISP and a list of attributes and attachments will automatically be generated from the .zip file. Whilst this does most of the work needed to be done in the second step of the event\'s creation, it is important to manually look over all the data that is being entered.');?></li>
	</ul>
<hr />
...
<ul>
	<li class="nav-item"><b><?php echo __('Category');?>:</b> <?php echo __('This drop-down menu explains the category of the attribute, meaning what aspect of the malware this attribute is describing. This could mean the persistence mechanisms of the malware or network activity, etc. For a list of valid categories, %s', $this->Html->link(__('click here', true), array('controller' => 'pages', 'action' => 'display', 'doc', 'categories_and_types')));?></li>
		...
		<li class="nav-item"><b><?php echo __('Contextual Comment');?>:</b> <?php echo __('Add a comment to the attribute. This will not be used for correlation.');?></li>
		<li class="nav-item"><b><?php echo __('Value');?>:</b> <?php echo __('The actual value of the attribute, enter data about the value based on what is valid for the chosen attribute type. For example, for an attribute of type ip-src (source IP address), 11.11.11.11 would be a valid value. For more information on types and values, %s.', $this->Html->link(__('click here', true), array('controller' => 'pages', 'action' => 'display', 'doc', 'categories_and_types')));?></li>
		<li class="nav-item"><b><?php echo __('Contextual Comment');?>:</b> <?php echo __('You can add some comments to the attribute that will not be used for correlation but instead serves as purely an informational field.');?></li>
		<li class="nav-item"><b><?php echo __('For Intrusion Detection System');?>:</b> <?php echo __('This option allows the attribute to be used as an IDS signature when exporting the NIDS data, unless it is being overruled by the white-list. For more information about the whitelist, head over to the %s section.', $this->Html->link(__('administration', true), array('controller' => 'pages', 'action' => 'display', 'doc', 'administration', '#' => 'whitelist'))); ?></li>
		<li class="nav-item"><b><?php echo __('Batch import');?>:</b> <?php echo __('If there are several attributes of the same type to enter (such as a list of IP addresses, it is possible to enter them all into the same value-field, separated by a line break between each line. This will allow the system to create separate lines for the each attribute.');?> </li>
</ul>
...
<ul>
<li class="nav-item"><b><?php echo __('Field');?></b>: <?php echo __('The name of the field along with an indication if the field is mandatory.');?></li>
<li class="nav-item"><b><?php echo __('Description');?></b>: <?php echo __('A short description of the field.');?></li>
<li class="nav-item"><b><?php echo __('Types');?></b>: <?php echo __('The value(s) that are valid for the field. In the case of several types being shown here, you can enter value(s) matching any one of the types, or in the case of a batch import field, any mixture of the given types.');?></li>
<li class="nav-item"><b><?php echo __('Text field');?></b>: <?php echo __('This field can either be a single line textfield or a multi-line text area. For the former, enter a single value of the above indicated type, whilst for the latter you cna paste a list of values separated by line-breaks.');?></li>
</ul>
...
<ul>
	<li class="nav-item"><b><?php echo __('Category');?>:</b> <?php echo __('The category is the same as with the attributes, it answers the question of what the uploaded file is meant to describe.');?></li>
	<li class="nav-item"><b><?php echo __('Distribution');?>:</b> <?php echo __('This drop-down list allows you to control who will be able to see this attachment.
			The distribution is inherited by attributes: the most restrictive setting wins.
			For more info <a href="#distribution">click here</a>.');?></li>
	<li class="nav-item"><b><?php echo __('Upload field');?>:</b> <?php echo __('By hitting browse, you can browse your file system and point the uploader to the file that you want to attach to the attribute. This will then be uploaded when the upload button is pushed.');?></li>
	<li class="nav-item"><b><?php echo __('Malware');?>:</b> <?php echo __('This check-box marks the file as malware and as such it will be zipped and passworded, to protect the users of the system from accidentally downloading and executing the file. Make sure to tick this if you suspect that the filed is infected, before uploading it.');?></li>
	<li class="nav-item"><b><?php echo __('Contextual Comment');?>:</b> <?php echo __('You can add some comments to the attribute that will not be used for correlation but instead serves as purely an informational field.');?></li>
</ul>
<hr />
...
<?php echo __('You can also import the data from a ThreatConnect export csv file. The following columns are used by the import tool (and are thus mandatory fields to select during the export)');?>: <br /><ul><li class="nav-item"><?php echo __('Type');?></li><li class="nav-item"><?php echo __('Value');?></li><li class="nav-item"><?php echo __('Confidence');?></li><li class="nav-item"><?php echo __('Description');?></li><li class="nav-item"><?php echo __('Source');?></li></ul><?php echo __('The result will be a list of attributes that get added to the currently selected event, each of which will be marked with a comment that indicates that its origin being from a ThreatConnect import.');?>
<hr />
...
<ul>
	<li class="nav-item"><b><?php echo __('Published');?>:</b> <?php echo __('Already published events are marked by a checkmark. Unpublished events are marked by a cross.');?></li>
	<li class="nav-item"><b><?php echo __('Org');?>:</b> <?php echo __('The organisation that created the event.');?></li>
	<li class="nav-item"><b><?php echo __('Owner Org');?>:</b> <?php echo __('The organisation that owns the event on this instance. This field is only visible to administrators.');?></li>
	<li class="nav-item"><b><?php echo __('ID');?>:</b> <?php echo __('The event\'s ID number, assigned by the system when the event was first entered (or in the case of an event that was synchronized, when it was first copied over - more on synchronisation in chapter xy)');?></li>
	<li class="nav-item"><b><?php echo __('Tags');?>:</b> <?php echo __('Tags that are assigned to this event.');?></li>
	<li class="nav-item"><b><?php echo __('#Attr.');?>:</b> <?php echo __('The number of attributes that the event has.');?></li>
	<li class="nav-item"><b><?php echo __('Email');?>:</b> <?php echo __('The e-mail address of the event\'s reporter. This is not visible to regular users. Organisation administrators can see the e-mail addresses of their own organisation\'s users.');?></li>
	<li class="nav-item"><b><?php echo __('Date');?>:</b> <?php echo __('The date of the attack.');?></li>
	<li class="nav-item"><b><?php echo __('Threat Level');?>:</b> <?php echo __('The risk level of the attack, the following levels are possible');?>:</li>
	<li style="list-style: none;">
		<ul>
			<li class="nav-item"><b><?php echo __('Low');?>:</b> <?php echo __('General Malware');?></li>
			<li class="nav-item"><b><?php echo __('Medium');?>:</b> <?php echo __('Advanced Persistent Threats (APTs)');?></li>
			<li class="nav-item"><b><?php echo __('High');?>:</b> <?php echo __('Sophisticated APTs and 0day exploits<');?>/li>
			<li class="nav-item"><b><?php echo __('Undefined');?>:</b> <?php echo __('This field can be left undefined and edited at a later date.');?></li>
		</ul>
	</li>
	<li class="nav-item"><b><?php echo __('Analysis');?>:</b> <?php echo __('Indicates the current stage of the analysis for the event, with the following possible options');?>:</li>
	<li style="list-style: none;">
		<ul>
			<li class="nav-item"><b><?php echo __('Initial');?>:</b> <?php echo __('The analysis is just beginning');?></li>
			<li class="nav-item"><b><?php echo __('Ongoing');?>:</b> <?php echo __('The analysis is in progress');?></li>
			<li class="nav-item"><b><?php echo __('Completed');?>:</b> <?php echo __('The analysis is complete');?></li>
		</ul>
	</li>
	<li class="nav-item"><b><?php echo __('Info');?>:</b> <?php echo __('A short description of the event, starting with an internal reference number.');?></li>
	<li class="nav-item"><b><?php echo __('Distribution');?>:</b> <?php echo __('This field indicates what the sharing privileges of the event. The options are described <a href="#distribution">here</a>.');?></li>
	<li class="nav-item"><b><?php echo __('Actions');?>:</b> <?php echo __('The controls that the user has to view or modify the event. The possible actions that are available (depending on user privileges - %s to find out more about privileges)', $this->Html->link(__('click here', true), array('controller' => 'pages', 'action' => 'display', 'doc', 'administration', '#' => 'roles'))); ?> :</li>
	<li style="list-style: none;">
		<ul>
			<li class="nav-item"><b><?php echo __('Publish');?>:</b> <?php echo __('Publishing an event will have several effects: The system will e-mail all eligible users that have auto-alert turned on (and having the needed privileges for the event, depending on its private classification) with a description of your newly published event, it will be flagged as published and it will be pushed to all eligible servers (to read more about synchronisation between servers, have a look at the %s).', $this->Html->link(__('section on connecting servers', true), array('controller' => 'pages', 'action' => 'display', 'doc', 'using_the_system', '#' => 'connect'))); ?></li>
			<li class="nav-item"><b><?php echo __('Edit');?>:</b> <?php echo __('Clicking on the edit button will bring up the same screen as the one used for creating new events, with the exception that all fields come filled out with the data of the event that is being edited. The distribution of an event can only be edited if you are a user of the creating organisation of the event. For more information on this view, refer to the section on <a href="#create">creating an event</a>.');?></li>
			<li class="nav-item"><b><?php echo __('Delete');?>:</b> <?php echo __('The system will prompt you before erasing the unwanted event.');?></li>
			<li class="nav-item"><b><?php echo __('View');?>:</b> <?php echo __('Will bring up the event view, which besides the basic information contained in the event list, will also include the following');?>:<br /><br />
		</ul>
	</li>
</ul>
...
<ul>
	<li class="nav-item"><b><?php echo __('ID');?>:</b> <?php echo __('The ID of the event.');?></li>
	<li class="nav-item"><b><?php echo __('Uuid');?>:</b> <?php echo __('In order to avoid collisions between events and attributes (during for example a sync) a Uuid is assigned that uniquely identifies each of them.');?></li>
	<li class="nav-item"><b><?php echo __('Org');?></b> <?php echo __('The organisation that has originally created the event. The logo (if it exists on the server, alternatively a string) representing the organisation is also shown int he right upper corner.');?></li>
	<li class="nav-item"><b><?php echo __('Contributors');?>:</b> <?php echo __('Shows a list of the organisations that have contributed to the event via proposals. If you click any of the logos listed here, you\'ll get redirected to a filtered event history view, including only the changes made by the organisation.');?></li>
	<li class="nav-item"><b><?php echo __('Tags');?>:</b> <?php echo __('A list of tags associated with the event. Clicking a tag will show a list of events with the same tag attached. The little cross next to each tag allows you to remove the tag from the event, whilst the \'+\' button allows you to assign a tag. For the latter two options to be visible, you have to have tagging permission.');?></li>
	<li class="nav-item"><b><?php echo __('Date');?>:</b> <?php echo __('The date of detection, set by the user that creates the event, not to be confused with the creation date of the event.');?></li>
	<li class="nav-item"><b><?php echo __('Threat Level');?>:</b> <?php echo __('The assigned threat level of the event.');?></li>
	<li class="nav-item"><b><?php echo __('Analysis');?>:</b> <?php echo __('The status of the analysis.');?></li>
	<li class="nav-item"><b><?php echo __('Distribution');?>:</b> <?php echo __('This shows the distribution rules applied to this event, controlling whether only the creating organisation can see (Your organisation only) it or everyone on the instance (This community only). The two remaining settings allow the event to be propagated to organisations on remote connected instances.');?></li>
	<li class="nav-item"><b><?php echo __('Info');?>:</b> <?php echo __('A short description of the event itself. Make sure not to put information in here that could be used for correlation purposes and be better suited as an Attribute.');?> </li>
	<li class="nav-item"><b><?php echo __('Published');?>:</b> <?php echo __('Whether the event has been published or not. Publishing allows the attributes of the event to be used for all eligible exports and it notifies users that have subscribed to the event alerts. Also, a publish initiates a push to all eligible instances.');?> </li>
</ul>
...
<ul>
	<li class="nav-item"><?php echo __('The pivot element to be deleted cannot be on the path that leads to the currently selected event');?></li>
	<li class="nav-item"><?php echo __('The pivot element residing in the graph\'s root can always be deleted - this will simply reset the current pivot thread');?></li>
</ul>
...
<ul>
	<li class="nav-item"><b><?php echo __('Date');?></b>: <?php echo __('The date of the last modification to the attribute. Proposals don\'t have a date of last edit.');?></li>
	<li class="nav-item"><b><?php echo __('Category');?></b>: <?php echo __('The category of the attribute or proposal. For a list of possible categories visit the section on <a href="%s/pages/display/doc/categories_and_types">categories and types</a>.', $baseurl);?></li>
	<li class="nav-item"><b><?php echo __('Type');?></b>: <?php echo __('The type of the attribute or proposal. For a list of possible categories visit the section on <a href="%s/pages/display/doc/categories_and_types">categories and types</a>.', $baseurl);?></li>
	<li class="nav-item"><b><?php echo __('Value');?></b>: <?php echo __('The value or value-pair of the attribute. This is the main payload of the attribute, which is described by the category and type columns. For certain types of attributes that are made up of value-pairs the two parts will be split by a pipe (|), such as for filename|md5. The value field(s) are used by the correlation engine to find relations between events. In value-pair attributes both values are correlated individually.');?> </li>
	<li class="nav-item"><b><?php echo __('Comment');?></b>: <?php echo __('Attributes can have a contextual comment to further describe the attribute. These comments are not used for correlation and are purely informative.');?> </li>
	<li class="nav-item"><b><?php echo __('Related Events');?></b>: <?php echo __('A list of the event IDs that also contain an attribute with the same value.');?> </li>
	<li class="nav-item"><b><?php echo __('IDS');?></b>: <?php echo __('Flags an attribute as an indicator of compromise, allowing it to be included in all of the eligible exports.');?> </li>
	<li class="nav-item"><b><?php echo __('Distribution');?></b>: <?php echo __('Defines the distribution of the attribute individually. An attribute can have a different distribution level than the event. In any case, the lowest distribution level of the two is used.');?> </li>
	<li class="nav-item"><b><?php echo __('Actions');?></b>: <?php echo __('The user can interact with the events through these buttons, which will be further described in the next portion of the guide as they differ for attributes and proposals.');?> </li>
</ul><br />
...
<ul>
	<li class="nav-item"><b><?php echo __('Attributes');?></b>: <?php echo __('Each uncoloured line represents an Attribute.');?></li>
	<li class="nav-item"><b><?php echo __('Proposals to an Event');?></b>: <?php echo __('Each gray line at the end of the list represents a Proposal to an event. These are proposals for a new attribute, mostly unrelated to any of the currently existing attributes. If the creator of the event accepts one of these a new attribute will be created.');?></li>
	<li class="nav-item"><b><?php echo __('Proposals to an Attribute');?></b>: <?php echo __('Each attribute can have several edit proposals. These will be placed right below the attribute that the proposal affects and - as with the event proposals - is coloured grey. The original attribute\'s row is coloured blue if a proposal exists for it.');?></li>
</ul>
...
<ul>
	<li class="nav-item"><b><?php echo __('Date');?>: </b><?php echo __('The date when the post was created.');?></li>
	<li class="nav-item"><b><?php echo __('Post navigation');?>: </b><?php echo __('This should the posts\' ID as well as a link to jump to the top of the discussion thread on the page itself.');?></li>
	<li class="nav-item"><b><?php echo __('Organisation logo');?>: </b><?php echo __('If such an image exists for the organisation that has posted the message, then the logo is shown.');?></li>
	<li class="nav-item"><b><?php echo __('Message');?>: </b><?php echo __('The body of the post itself. This can also include automatically generated links to other events and threads as well as show quoted test in embedded bubbles. Editing an event will also append a post with a message indicating that it was edited together with the timestamp of the edit.');?></li>
	<li class="nav-item"><b><?php echo __('User');?>: </b><?php echo __('The e-mail address of the poster if he/she is from the organisation as the current user. Alternatively a generated sting is shown that includes the user ID of the user, so that his/her e-mail address could remain hidden whilst still being identifiable.');?></li>
	<li class="nav-item"><b><?php echo __('Action buttons');?>: </b><?php echo __('Edit, Delete and Reply. The first two of the three options are only available to the poster of the message or a site admin. Quoting a post will automatically include the original message in [quote] tags.');?> </li>
</ul>
<?php echo __('Here is a list of the various tools you can use while using this feature');?>:<br /><br />
<ul>
	<li class="nav-item"><b><?php echo __('Pagination');?>:</b> <?php echo __('There are 5 posts visible on each event page, if there have been more messages posted, use the previous and next button to navigate through the thread. This will not reload the rest of the page.');?></li>
	<li class="nav-item"><b><?php echo __('Discussion Tags');?>:</b> <?php echo __('Users can quote something by encapsulating it in [quote][/quote] tags, they can create a link to another event with the [event][/event] tags or to another discussion thread with [thread][/thread].');?></li>
	<li class="nav-item"><b><?php echo __('Quick Post');?>:</b> <?php echo __('Adding a post will take the user to a separate add Post page, something that can be a bit of an inconvenience. To avoid this, there is a quick post button, where users can add messages on the fly without having to reload the page. On top of the quick post field, 3 buttons allow users to generate quote, event and thread tags quickly.');?> </li>
</ul>
<hr />
...
<ul>
<li class="nav-item"><b><?php echo __('Org');?></b>: <?php echo __('The logo (or in the lack thereof a string representation) of the organisation.');?></li>
<li class="nav-item"><b><?php echo __('Action');?></b>: <?php echo __('Each entry in the log happens during an action, such as the creation, modification or deletion of data and some special actions (such as accepting a proposal). This field shows which action caused the entry to be created.');?> </li>
<li class="nav-item"><b><?php echo __('Model');?></b>: <?php echo __('As described above, a log entry is generated on certain actions. This field shows which type of data was affected that caused the log entry to be created (such as a change to the event, the creation of an attribute, the discarding of a proposal, etc).');?></li>
<li class="nav-item"><b><?php echo __('Title');?></b>: <?php echo __('This is a short description of the change itself and it is not nearly as detailed as the information administrators get in the audit logs. However, for attributes and proposals the category / type and value of the created or edited attribute is shown.');?> </li>
<li class="nav-item"><b><?php echo __('Created');?></b>: <?php echo __('The date and time of the log entrys\' creation.');?></li>
</ul>
<hr />
<h3><?php echo __('Listing all attributes');?>:</h3>
	...
	<ul>
		<li class="nav-item"><b><?php echo __('Event');?>:</b> <?php echo __('This is the ID number of the event that the attribute is tied to. If an event belongs to your organisation, then this field will be coloured red.');?></li>
		<li class="nav-item"><b><?php echo __('Org');?>:</b> <?php echo __('The organisation that has created the event.');?></li>
		<li class="nav-item"><b><?php echo __('Category');?>:</b> <?php echo __('The category of the attribute, showing what the attribute describes (for example the malware\'s payload). For more information on categories, go to section xy');?></li>
		<li class="nav-item"><b><?php echo __('Type');?>:</b> <?php echo __('The type of the value contained in the attribute (for example a source IP address). For more information on types, go to section xy');?></li>
		<li class="nav-item"><b><?php echo __('Value');?>:</b> <?php echo __('The actual value of the attribute, describing an aspect, defined by the category and type fields of the malware (for example 11.11.11.11).');?></li>
		<li class="nav-item"><b><?php echo __('Comment');?>:</b> <?php echo __('An optional contextual comment attached to the attribute.');?></li>
		<li class="nav-item"><b><?php echo __('IDS');?>:</b> <?php echo __('Shows whether the attribute has been flagged for NIDS signature generation or not.');?></li>
		<li class="nav-item"><b><?php echo __('Actions');?>:</b> <?php echo __('A set of buttons that allow you to view the event that the attribute is tied to, to edit the attribute (using the same view as what is used to set up attributes, but filled out with the attribute\'s current data) and a delete button.');?></li>
	</ul>
...
<ul>
<li class="nav-item"><b><?php echo __('Name');?></b>: <?php echo __('Pick a name for the tag. Try to use consistent naming conventions across your instance, to avoid confusion.');?></li>
<li class="nav-item"><b><?php echo __('Colour');?></b>: <?php echo __('You can choose a colour for the tag by clicking on the colour field and using the colour picker tool. Try to avoid having duplicate or similar looking colours to help avoid confusion.');?></li>
</ul>
<hr />
...
<ul>
	<li class="nav-item"><b><?php echo __('Name');?></b>: <?php echo __('The name of the template should describe what type of an event it should be used to generate attributes.');?></li>
	<li class="nav-item"><b><?php echo __('Tags');?></b>: <?php echo __('You can attach tags to the template - an event populated using the template would automatically receive the tag(s). Add new tags using the + button. If you change your mind about a tag you can remove it with the cross next to the tag name.');?></li>
	<li class="nav-item"><b><?php echo __('Event Description');?></b>: <?php echo __('A short description about the events that this template should be used for.');?></li>
	<li class="nav-item"><b><?php echo __('Share this template with others');?></b>: <?php echo __('The template can be set to be usable by any organisation on the instance or only by the one that has created it.');?></li>
</ul>
...
<p><?php echo __('The following fields have to be filled out');?>:</p>
<ul>
	<li class="nav-item"><b><?php echo __('Name');?></b>: <?php echo __('The field name that will be presented to the user.');?></li>
	<li class="nav-item"><b><?php echo __('Description');?></b>: <?php echo __('A brief description of the element. Make sure that you provide sufficient information to the user to make it obvious what is expected.');?></li>
	<li class="nav-item"><b><?php echo __('Category');?></b>: <?php echo __('The category used for any attributes created using this template element.');?></li>
	<li class="nav-item"><b><?php echo __('Type');?></b>: <?php echo __('The type or complex type used for any attributes created using this template element. Complex types allow for several related types to be used on data entry. For example, a "file" complex type element allows for filenames and hashes.');?></li>
	<li class="nav-item"><b><?php echo __('Use Complex types');?></b>: <?php echo __('If the category permits it, switch to a complex type using this checkbox.');?></li>
	<li class="nav-item"><b><?php echo __('Automatically mark for IDS');?></b>: <?php echo __('If checked, any attributes generated using this element will be marked for IDS exporting.');?></li>
	<li class="nav-item"><b><?php echo __('Mandatory element');?></b>: <?php echo __('If the elemnt is marked as mandatory, then the template form can only be submitted by users if this field is filled out.');?></li>
	<li class="nav-item"><b><?php echo __('Batch import element');?></b>: <?php echo __('Allow for multiple values to be entered (separated by line breaks).');?></li>
</ul>
...
<ul>
	<li class="nav-item"><b><?php echo __('Name');?></b>: <?php echo __('The field name that will be presented to the user.');?></li>
	<li class="nav-item"><b><?php echo __('Description');?></b>: <?php echo __('A brief description of the element. Make sure that you provide sufficient information to the user to make it obvious what is expected.');?></li>
	<li class="nav-item"><b><?php echo __('Category');?></b>: <?php echo __('The category to be used by all attachments uploaded through this element.');?></li>
	<li class="nav-item"><b><?php echo __('Malware');?></b>: <?php echo __('If the uploaded files are malicious and should be encrypted and password protected, mark this checkbox.');?></li>
	<li class="nav-item"><b><?php echo __('Mandatory element');?></b>: <?php echo __('If it should be required to upload an attachment, check this checkbox.');?></li>
	<li class="nav-item"><b><?php echo __('Batch import element');?></b>: <?php echo __('Ticking this checkbox allows users to upload several files using this element.');?></li>
</ul>
...
<p><?php echo __('The following fields have to be filled out');?>:</p>
<ul>
	<li class="nav-item"><b><?php echo __('Name');?></b>: <?php echo __('The name of the section that will be presented to the user.');?></li>
	<li class="nav-item"><b><?php echo __('Text');?></b>: <?php echo __('The description of the section. Explain briefly to the user what the following attribute/file elements will be dealing with. There are several ways to split a template into sections, try to have ease of use in mind while creating it.');?></li>
</ul>
<hr />
...
<ul>
<li class="nav-item"><b><?php echo __('Type');?></b>: <?php echo __('The type of the export (such as XML, Suricata, MD5, etc.).');?></li>
<li class="nav-item"><b><?php echo __('Last Update');?></b>: <?php echo __('The generation date of the current cache for the given export type.');?></li>
<li class="nav-item"><b><?php echo __('Description');?></b>: <?php echo __('A description of the export format.');?> </li>
<li class="nav-item"><b><?php echo __('Outdated');?></b>: <?php echo __('This compares the cache generation date to the last timestamp when an event was updated and lets you know whether the cache is outdated or not.');?> </li>
<li class="nav-item"><b><?php echo __('Progress');?></b>: <?php echo __('Shows the progress of the last initiated generation process.');?></li>
<li class="nav-item"><b><?php echo __('Actions');?></b>: <?php echo __('Download or Generate the given cache with these buttons.');?> </li>
</ul>
...
<ul>
	<li class="nav-item"><b><?php echo __('Base URL');?>:</b> <?php echo __('The URL of the remote server.');?></li>
	<li class="nav-item"><b><?php echo __('Organization');?>:</b> <?php echo __('The organisation that runs the remote server. It is very impoportant that this setting is filled out exactly as the organisation name set up in the bootstrap file of the remote instance.');?></li>
	<li class="nav-item"><b><?php echo __('Authkey');?>:</b> <?php echo __('The authentication key that you have received from the hosting organisation of the remote instance.');?></li>
	<li class="nav-item"><b><?php echo __('Push');?>:</b> <?php echo __('This check-box controls whether your server is allowed to push to the remote instance.');?></li>
	<li class="nav-item"><b><?php echo __('Pull');?>:</b> <?php echo __('This check-box controls whether your server can request to pull all data from the remote instance.');?></li>
	<li class="nav-item"><b><?php echo __('Unpublish event (Push only)');?>:</b> <?php echo __('This check-box controls to unpublish new event (working with Push events).');?></li>
	<li class="nav-item"><b><?php echo __('Publish without email (Pull only)');?>:</b> <?php echo __('This check-box controls whether your server is allowed to publish event without email (working with Pull events).');?></li>
	<li class="nav-item"><b><?php echo __('Self Signed');?>:</b> <?php echo __('Ticking this checkbox will allow syncing with instances using self-signed certificates.');?></li>
	<li class="nav-item"><b><?php echo __('Certificate File');?>:</b> <?php echo __('If the instance that you want to connect to has their entire own certificate chain, you can use this to import a .pem file with it and override CakePHP\'s standard root CA file.');?></li>
</ul>
...
<ul>
	<li class="nav-item"><?php echo __('The synchronisation user has to have the sync permission and full read/write/publish privileges turned on');?></li>
	<li class="nav-item"><?php echo __('Both the sync user and the organisation setting in your instance\'s Config/bootstrap.php file have to match the organisation identifier of the hosting organisation.');?></li>
</ul>
...
<ul>
	<li class="nav-item"><b><?php echo __('Editing the connection to the');?>:</b> <?php echo __('By clicking edit a view, <a href=#new_server>that is identical to the new instance view</a>, is loaded, with all the current information of the instance pre-entered.');?></li>
	<li class="nav-item"><b><?php echo __('Deleting the connection to the instance');?>:</b> <?php echo __('Clicking the delete button will delete the link to the instance.');?></li>
	<li class="nav-item"><b><?php echo __('Push all');?>:</b><?php echo __(' By clicking this button, all events that are eligible to be pushed on the instance you are on will start to be pushed to the remote instance. Events and attributes that exist on the far end will be updated.');?></li>
	<li class="nav-item"><b><?php echo __('Pull all');?>:</b> <?php echo __('By clicking this button, all events that are set to be pull-able or full access on the remote server will be copied to this instance. Existing events will not be updated.');?></li>
</ul>
<hr />
