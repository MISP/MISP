...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "misp.mysql.fullname" -}}
{{- printf "%s-mysql" (include "misp.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "misp.redis.fullname" -}}
{{- printf "%s-redis" (include "misp.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
