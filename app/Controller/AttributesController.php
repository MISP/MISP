...
class AttributesController extends AppController
{
     ...
     * POST → accepts { global_ids: int[], local_ids: int[] } as JSON, diffs
     *        against the current state and calls attach/detach with the
     *        'attribute' target scope.
     *
     * The body is AppController::_editGalaxiesForScope(), shared with
     * EventsController::editEventGalaxies().
     *
     * @param int|string $id Attribute ID or UUID
     */
    public function editAttributeGalaxies($id = null)
    {
        ...
        return $this->_editGalaxiesForScope(
            'attribute',
            $attributeId,
            $attribute['AttributeTag'],
            $this->__canModifyTag($attribute),
            __('Invalid attribute'),
            ['check_publish' => true]
        );
    }
