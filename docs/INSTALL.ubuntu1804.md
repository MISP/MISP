...
Make sure you are reading the parsed version of this Document. When in doubt see [Installation instructions for Ubuntu 18.04.5-server](https://misp.github.io/MISP/INSTALL.ubuntu1804).
...
!!! notice
    If the next line is `[!generic/core.md!]()`, see [Installation instructions for Ubuntu 18.04.5-server](https://misp.github.io/MISP/INSTALL.ubuntu1804).
