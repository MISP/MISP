	...
	<p><?php echo __('Remove sighting (%s)?', h($id));?></p>
		<table>
			<tr>
				...
				<td style="vertical-align:top;">
					<span role="button" tabindex="0" aria-label="<?php echo __('Cancel');?>" title="<?php echo __('Cancel');?>" class="btn btn-dark" id="PromptNoButton" onClick="cancelPrompt(1);"><?php echo __('No');?></span>
				</td>
			</tr>
		</table>
	</div>
