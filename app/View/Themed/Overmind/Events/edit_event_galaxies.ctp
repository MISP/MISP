<?php
/*
 * Overmind modal — edit event galaxy clusters
 * GET  /events/editEventGalaxies/{id}
 * POST /events/editEventGalaxies/{id}  body: JSON { global_ids: int[], local_ids: int[] }
 *
 * Variables:
...
$postUrl   = h($baseurl . '/events/editEventGalaxies/' . $eventId);
...
<script>
    ...
    /* Cluster badge style identical to view_event_galaxies.ctp */
        ...
        saveBtn.addEventListener('click', function () {
            ...
            .then(function (data) {
                if (data.saved) {
                    ...
                    var reloadFn = window['reloadGalaxiesCard_' + uid];
