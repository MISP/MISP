...
<h2>User Management and Global Actions</h2>
	...
	<a name ="manage"></a><h3>Managing your account:</h3>
		...
		<ul>
			<li style="list-style-type:none"><p><img src="/img/doc/my_profile.png" alt="" style="float:right;" title = "Change any of your profile settings here."/></p><br /></li>
			...
			<br /><p><img src="/img/doc/reset.png" alt="" title = "Clicking on reset will generate a new key for you and invalidate the old one, blocking it from being used."/></p></li>
		</ul>
	<br /><hr /><br />
