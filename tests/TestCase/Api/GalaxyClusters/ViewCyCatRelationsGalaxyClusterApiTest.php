...
class ViewCyCatRelationsGalaxyClusterApiTest extends TestCase
{
    use ApiTestTrait;

    protected const ENDPOINT = '/galaxyClusters/viewCyCatRelations';
    ...
    // public function testViewCyCatRelations(): void
    // {
    //     Configure::write('Plugin.CyCat_enable', true);
