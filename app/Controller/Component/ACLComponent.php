...
class ACLComponent extends Component
{
    ...
    const ACL_LIST = array(
        ...
        'objectTemplates' => array(
            ...
            'deleteSelection' => array('perm_object_template', 'theming_enabled'),
            'toggleActive' => array('theming_enabled'),
            'getToggleField' => array(),
        ...
        'taxonomies' => array(
            ...
            'massEnable'  => array('theming_enabled'),
            'massDisable'  => array('theming_enabled'),
            'massRequire'  => array('theming_enabled'),
            'massOptional'  => array('theming_enabled'),
            'massHighlight'  => array('theming_enabled'),
            'massRemoveHighlight'  => array('theming_enabled'),
            'update' => array(),
            'import' => [],
            'export' => ['*'],
            'view' => array('*'),
        ...
        'templateElements' => array(
            ...
            'addV2' => array('perm_template', 'theming_enabled'),
            'delete' => array('perm_template'),
            'deleteSelection' => array('perm_template', 'theming_enabled'),
            'edit' => array('perm_template'),
            'editV2' => array('perm_template', 'theming_enabled'),
            'index' => array('*'),
