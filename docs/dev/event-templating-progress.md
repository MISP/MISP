...
- [ ] Vendor SortableJS (pinned version) in `app/webroot/js/vendor/sortablejs/`
- [ ] Vendor Alpine.js 3.x (pinned version) in `app/webroot/js/vendor/alpinejs/`
...
- [ ] `app/View/Themed/Overmind/EventTemplates/index.ctp` (BS5 card/table)
- [ ] `app/View/Themed/Overmind/EventTemplates/view.ctp`
...
- [ ] Alpine.js component(s) driving the builder state
