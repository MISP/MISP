...
class FavouriteTagsController extends AppController {
	...
	public function toggle() {
		...
		if ($success) {
			return new Response(array('body'=> json_encode(array('saved' => true, 'success' => $message . ' was successful.')), 'status'=>200));
		} else {
			return new Response(array('body'=> json_encode(array('saved' => false, 'fails' => $message . ' has failed.')), 'status'=>200));
		}
	}
