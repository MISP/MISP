...
?>
	...
	<div class="overlay_spacing">
		<table>
			...
			<td style="vertical-align:top;">
				<span role="span" tabindex="0" aria-label="<?php echo __('Cancel');?>" title="<?php echo __('Cancel');?>" class="btn btn-dark" id="cancel_attribute_add" onClick="cancelPopoverForm();"><?php echo __('Cancel');?></span>
			</td>
			</tr>
		</table>
	</div>
