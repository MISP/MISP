<div class="logs index">
    ...
    <table class="table table-striped table-hover table-condensed">
        <tr>
            <th><?php echo $this->LightPaginator->sort('id');?></th>
            <?php if (Configure::read('MISP.log_client_ip')) echo '<th>' . $this->LightPaginator->sort('ip', 'IP') . '</th>';?>
            ...
            <th><?php echo $this->LightPaginator->sort('model_id', __('Model ID'));?></th>
            <th><?php echo $this->LightPaginator->sort('action');?></th>
            <th><?php echo $this->LightPaginator->sort('title');?></th>
            <th><?php echo $this->LightPaginator->sort('change');?></th>
        </tr>
