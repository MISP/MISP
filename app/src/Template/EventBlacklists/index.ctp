...
foreach ($response as $item): ?>
	<tr>
		...
		<td class="short action-links">
			...
			<?php echo $this->Form->postLink('', array('action' => 'delete', h($item['EventBlacklist']['id'])), array('class' => 'icon-trash', 'title' => 'Delete'), __('Are you sure you want to delete the blacklist entry for the event UUID {0}?', h($item['EventBlacklist']['event_uuid']))); ?>
		</td>
	</tr><?php
endforeach; ?>
	</table>
