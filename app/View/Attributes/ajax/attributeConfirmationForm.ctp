...
<p><?php echo $hard ? $hard_message : $soft_message; ?></p>
	<table>
		<tr>
			...
			<td style="vertical-align:top;">
				<span class="btn btn-dark" title="<?php echo __('No'); ?>" role="button" tabindex="0" aria-label="<?php echo __('No'); ?>" id="PromptNoButton" onClick="cancelPrompt();"><?php echo __('No'); ?></span>
			</td>
		</tr>
	</table>
</div>
