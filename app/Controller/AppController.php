...
class AppController extends Controller
{
    ...
    /**
     * Hack to load `MispAttribute` to `Attribute` variable
    ...
    public function loadModel($modelClass = null, $id = null)
    {
        if ($modelClass === 'Attribute') {
            $this->Attribute = ClassRegistry::init([
                'class' => 'MispAttribute', 'alias' => 'Attribute', 'id' => $id
            ]);
            return true;
        }

        return parent::loadModel($modelClass, $id); // TODO: Change the autogenerated stub
    }
}
