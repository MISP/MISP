<div class="index">
	...
	<table class="table table-striped table-hover table-condensed">
		...
		<tr id="row_<?php echo $k; ?>" class="freetext_row">
			...
			<td class="short">
				<input type="text" id="<?php echo 'Attribute' . $k . 'Comment'; ?>" style="padding:0px;height:20px;margin-bottom:0px;" placeholder="Imported via the freetext import." <?php if (isset($item['comment']) && $item['comment'] !== false) echo 'value="' . $item['comment'] . '"'?>/>
			</td>
