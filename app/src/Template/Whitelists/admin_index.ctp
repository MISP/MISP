...
foreach ($list as $item):?>
	<tr>
		...
		<td class="short action-links">
			...
			<?php echo $this->Form->postLink('', array('admin' => true, 'action' => 'delete', $item['Whitelist']['id']), array('class' => 'icon-trash', 'title' => 'Delete'), __('Are you sure you want to delete "{0}"?', $item['Whitelist']['name']));?>
		</td>
	</tr><?php
endforeach;?>
	</table>
