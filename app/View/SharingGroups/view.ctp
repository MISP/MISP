	...
	<dl>
		...
		<dd>
			<?php
				...
				else echo '<span class="' . ($sg['SharingGroup'][$f] ? 'fa fa-check' : 'fa fa-remove') . '"></span>';
			?>&nbsp;
		</dd>
		<?php
			endforeach;
		...
		<b><?php echo __('Organisations');?></b>
			<table class="table table-striped table-hover table-condensed">
				...
				<tr>
					...
					<td><span class="<?php echo ($sgo['Organisation']['local'] ? 'fa fa-check' : 'fa fa-remove'); ?>"></span></td>
					<td><span class="<?php echo ($sgo['extend'] ? 'fa fa-check' : 'fa fa-remove'); ?>"></span></td>
				</tr>
				<?php
					endforeach;
				?>
		...
		<b>Instances</b>
			<table class="table table-striped table-hover table-condensed">
				...
				<tr>
					...
					<td><span class="<?php echo ($sgs['all_orgs'] ? 'fa fa-check' : 'fa fa-remove'); ?>"></span></td>
				</tr>
				<?php
						endforeach;
				?>
