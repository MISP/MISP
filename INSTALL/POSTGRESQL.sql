...
INSERT INTO "roles" ("id", "name", "created", "modified", "perm_add", "perm_modify", "perm_modify_org", "perm_publish", "perm_delegate", "perm_sync", "perm_admin", "perm_audit", "perm_full", "perm_auth", "perm_site_admin", "perm_regexp_access", "perm_tagger", "perm_template", "perm_sharing_group", "perm_tag_editor", "perm_sighting", "perm_object_template", "default_role", "memory_limit", "max_execution_time", "restricted_to_site_admin", "perm_publish_zmq", "perm_publish_kafka", "perm_decaying", "enforce_rate_limit", "rate_limit_count", "perm_galaxy_editor", "perm_warninglist", "perm_view_feed_correlations", "perm_analyst_data", "perm_skip_otp", "perm_server_sign", "perm_sync_internal", "perm_sync_authoritative", "restsearch_limit_result") VALUES
(1, 'admin', NOW(), NOW(), 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', NULL, NULL, 'FALSE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', 0, 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 0),
(2, 'Org Admin', NOW(), NOW(), 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', 'TRUE', 'TRUE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', 'FALSE', NULL, NULL, 'FALSE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', 0, 'TRUE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 0),
(3, 'User', NOW(), NOW(), 'TRUE', 'TRUE', 'TRUE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'TRUE', NULL, NULL, 'FALSE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 0, 'TRUE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 0),
(4, 'Publisher', NOW(), NOW(), 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', NULL, NULL, 'FALSE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', 0, 'TRUE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 0),
(5, 'Sync user', NOW(), NOW(), 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', 'TRUE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', 'FALSE', NULL, NULL, 'FALSE', 'TRUE', 'TRUE', 'TRUE', 'FALSE', 0, 'TRUE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 0),
(6, 'Read Only', NOW(), NOW(), 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'TRUE', 'FALSE', 'TRUE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', NULL, NULL, 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 0, 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 'FALSE', 0)
ON CONFLICT DO NOTHING;
