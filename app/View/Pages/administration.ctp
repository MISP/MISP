...
<p><img src="/img/doc/add_server.png" alt="" title = "Make sure that you enter the authentication key that you have been assigned on the remote server instead of the one you got from this server."/></p><br />
<ul>
...
<img src="/img/doc/whitelist.png" alt="" title = "You can edit or delete currently white-listed addresses using the action buttons on this list."/><br /><br />
<br /><hr /><br />
...
<img src="/img/doc/add_user.png" alt="" style="float:right;" title = "Fill this form out to add a new user. Keep in mind that the drop-down menu titled Group controls the privileges the user will have."/>
...
<img src="/img/doc/list_users.png" alt="" title = "View, Edit or Delete a user using the action buttons to the right."/><br /><br />
<ul>
...
<img src="/img/doc/list_groups.png" alt="" title = "You can View, Edit or Delete groups using the action buttons to the right in each row. Keep in mind that a group has to be devoid of members before it can be deleted."/><br /><br />
<br /><hr /><br />
...
<img src="/img/doc/list_logs.png" alt="" title = "Here you can view a list of all logged actions."/><br /><br />
<ul>
...
<img src="/img/doc/search_log.png" alt="" style="float:right;" title = "You can search the logs using this form, narrow down your search by filling out several fields."/>
