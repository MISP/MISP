...
<?php echo $this->Form->create('Event', [
    ...
    'url' => $baseurl . '/events/massAlert/' . $ids
]); ?>
    <legend><?= __('Publish and alert %d event(s)?', count($idList)) ?></legend>
    <div style="padding:5px;">
        <p><?= __('Are you sure you want to publish and send alert emails for these events?') ?></p>
