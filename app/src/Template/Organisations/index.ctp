	...
	<tr>
		...
		<td class="short action-links">
			<?php if ($isSiteAdmin): ?>
				...
				<?php
					echo $this->Form->postLink('', array('admin' => true, 'action' => 'delete', $org['Organisation']['id']), array('class' => 'icon-trash', 'title' => 'Delete'), __('Are you sure you want to delete {0}?', $org['Organisation']['name']));
				?>
			<?php endif; ?>
