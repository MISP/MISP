<?php
    echo $this->Form->create('ShadowAttribute', array('class' => 'inline-form inline-field-form', 'id' => 'ShadowAttribute_' . $object['id'] . '_category_form', 'url' => $baseurl . '/shadow_attributes/editField/' . $object['id']));
?>
