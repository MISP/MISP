...
<li><?php echo $this->Form->postLink('Upgrade to 2.4', '/servers/upgrade2324');?> (This script will make the final changes to the database to bring it up to speed with 2.4)</li>
<li><?php echo $this->Form->postLink('BETA UPDATES', '/servers/updateDatabase/24betaupdates');?> (This script will update your db from an earlier version of the beta)</li>
</ul>
</div>
<?php 
