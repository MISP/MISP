<?php
/*
 * Overmind modal — edit event tags
 * GET  /events/editEventTags/{id}
 * POST /events/editEventTags/{id}  body: JSON { global_ids: int[], local_ids: int[] }
 *
 * Variables:
...
$postUrl   = h($baseurl . '/events/editEventTags/' . $eventId);
        ...
        saveBtn.addEventListener('click', function () {
            ...
            .then(function (data) {
                if (data.saved) {
                    ...
                    var reloadFn = window['reloadTagsCard_' + uid];
