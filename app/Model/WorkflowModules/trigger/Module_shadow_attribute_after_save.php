...
class Module_shadow_attribute_after_save extends WorkflowBaseTriggerModule
{
    ...
    public $description = 'This trigger is called just after a Shadow Attribute has been saved in the database';
    public $icon = 'comment';
    public $inputs = 0;
    public $outputs = 1;
    ...
    {
        parent::__construct();
        $this->trigger_overhead_message = __('This trigger is called each time a Shadow Attribute has been saved. This means that when a large quantity of Shadow Attributes are being saved (e.g. Feed pulling or synchronisation), the workflow will be run for as many time as there are Shadow Attributes.');  
    }
