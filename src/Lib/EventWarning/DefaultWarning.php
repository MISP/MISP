    ...
    public function tlpDistributionCheck(array $event, array &$warnings)
    {
        if (!empty($event['EventTag'])) {
            foreach ($event['EventTag'] as $eT) {
                ...
                if ($tagName === 'tlp:white' && $event['distribution'] != Distribution::ALL_COMMUNITIES) {
                ...
                } else if ($tagName === 'tlp:green' && !in_array($event['distribution'], [Distribution::COMMUNITY_ONLY, Distribution::CONNECTED_COMMUNITIES, Distribution::ALL_COMMUNITIES])) {
                ...
                } else if (in_array($tagName, ['tlp:amber', 'tlp:red'], true) && $event['distribution'] == Distribution::ALL_COMMUNITIES) {
