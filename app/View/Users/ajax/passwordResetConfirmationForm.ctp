...
<div style="padding-left:5px;padding-right:5px;padding-bottom:5px;">
	...
	<?php echo $this->Form->input('firstTime', array('label' => false, 'type' => 'checkbox','class' => 'form-check-input', 'div' => false, 'style' => 'border:0px;margin:0px;')); ?><?php echo __('First time registration');?>
	</p>
	<table>
		<tr>
