<div class="event index">
    ...
    <p><?php echo __('You can configure your tools to automatically download a file one of the Zeek types.');?></p>
    <pre><?php
    ...
    <p><?php echo __('It is possible to restrict the zeek exports on based on a set of filters. POST a JSON object or an XML at the Zeek API to filter the results.');?></p>
