...
<img src="/img/doc/add_user.png" style="float:right;" title = "Fill this form out to add a new user. Keep in mind that the drop-down menu titled Roles controls the privileges the user will have."/>
...
When creating a new role-group, you will have to enter a name for the role to be created and choose a permission option (as described above), one for each permission flag.<br><br>
<h3>Listing roles:</h3>
By clicking on the List Roles button, you can view a list of all the currently registered role-groups and their permission settings. In addition, you can find buttons that allow you to edit and delete the roles. Keep in mind that you will need to first remove every member from a role before you can delete it.<br><br>
<img src="/img/doc/list_groups.png" title = "You can View, Edit or Delete roles using the action buttons to the right in each row. Keep in mind that a role has to be devoid of members before it can be deleted."/><br><br>
<br><hr/><br> 
