...
class Attribute extends AppModel
{
    ...
    public $typeDefinitions = array(
            ...
            'hashh-md5' => array('desc' => "hashh is a network fingerprinting standard which can be used to identify specific Client SSH implementations. The fingerprints can be easily stored, searched and shared in the form of an MD5 fingerprint.", 'default_category' => 'Network activity', 'to_ids' => 1),
            'hashhserver-md5' => array('desc' => "hashhServer is a network fingerprinting standard which can be used to identify specific Server SSH implementations. The fingerprints can be easily stored, searched and shared in the form of an MD5 fingerprint.", 'default_category' => 'Network activity', 'to_ids' => 1),
