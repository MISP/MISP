			...
			<tr>
				...
				<?php
					...
					<tr>
						...
						<td class="short">
							<?php
								echo $this->Form->postLink('', array('controller' => 'servers', 'action' => 'deleteFile' , $k , $f['filename']), array('class' => 'icon-trash', 'title' => 'Delete'), __('Are you sure you want to delete {0}?', $f['filename']));
							?>
						</td>
					</tr>
				<?php
