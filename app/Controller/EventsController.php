...
class EventsController extends AppController
{
    ...
    public function addIOC($id)
    {
        ...
        if (!$this->__canModify($this->Event->data)) {
    ...
    public function merge($target_id=null, $source_id=null)
    {
        ...
        if (!$this->__canModify($target_event)) {
            throw new UnauthorizedException(__('You do not have permission to do that.'));
        }
        if ($this->request->is('post')) {
    ...
    public function edit($id = null)
    {
        ...
        if (!$this->__canModify($this->Event->data) && !($this->userRole['perm_sync'] && $this->_isRest())) {
    ...
    public function freeTextImport($id, $adhereToWarninglists = false, $returnMetaAttributes = false)
    {
        ...
        if ($this->request->is('post')) {
            ...
            $this->set('proposals', !$this->__canModify($event));
            $this->set('distributions', $distributions);
            $this->set('sgs', $sgs);
            $this->set('event', $event);
            $this->set('mayModify', $this->__canModify($event));
    ...
    private function __pushFreetext($attributes, array $event, $distribution = false, $sg = false, $adhereToWarninglists = false)
    {
        ...
        $proposals = !$this->__canModify($event);
    ...
    public function saveFreeText($id)
    {
        ...
        if ($this->request->is('post')) {
            ...
            $proposals = !$this->__canModify($event) || (isset($this->request->data['Attribute']['force']) && $this->request->data['Attribute']['force']);
    ...
    */
     ...
     * @return bool
     */
    private function __canModify(array $event)
    {
