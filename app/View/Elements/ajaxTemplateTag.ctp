        ...
        <table>
            <tr>
                ...
                <td style="padding-left:0px;padding-right:5px;">
                    <span class="tagSecondHalf useCursorPointer" title="<?php echo __('Remove tag');?>" role="button" tabindex="0" aria-label="<?php echo __('Remove tag');?>" onClick="removeTemplateTag('<?php echo h($tag['Tag']['id']); ?>');">x</span>
                </td>
                <?php endif; ?>
            </tr>
        </table>
