<div class="actions <?php echo $debugMode;?>">
	<ol class="nav nav-list">
			...
			<ul class="nav nav-list">
				<li><a href="#diagnostics">Settings and Diagnostics</a></li>
...
<div class="index">
	...
	<p><img src="/img/doc/settings_1.png" alt = "" title = "Server settings overview with all of the tabs explained."/></p><br />
	...
	<p><img src="/img/doc/settings_2.png" alt = "" title = "The settings tabs explained."/></p><br />
	...
	<ul>
		...
		<li><b>Setting</b>: The setting name.</li>
		<li><b>Value</b>: The current value of the setting.</li>
	...
	<p><img src="/img/doc/settings_3.png" alt = "" title = "The workers tab."/></p><br />
	...
	<ul>
		<li><b>Read Only:</b> This allows the user to browse events that his organisation has access to, but doesn't allow any changes to be made to the database.</li>
		<li><b>Manage My Own Events:</b> The second option, gives its users rights to create, modify or delete their own events, but they cannot publish them.</li>
		<li><b>Manage Organization Events:</b> allows users to create events or modify and delete events created by a member of their organisation.</li>
		<li><b>Manage &amp; Publish Organisation Events:</b> This last setting, gives users the right to do all of the above and also to publish the events of their organisation.</li>
		<li><b>Perm sync:</b> This setting allows the users of the role to be used as a synchronisation user. The authentication key of this user can be handed out to the administrator of a remote MISP instance to allow the synchronisation features to work.</li>
		<li><b>Perm auth:</b> This setting enables the authentication key of the role's users to be used for rest requests. </li>
		<li><b>Perm admin:</b> Gives the user limited administrator privileges, this setting is used for the organisation admins. </li>
		<li><b>Perm site admin:</b> Gives the user full administrator privileges, this setting is used for the site admins. </li>
		<li><b>Perm audit:</b> Grants access to the logs. With the exception of site admins, only logs generated by the user's own org are visible. </li>
		<li><b>Perm regexp access:</b> Allows the users with this permission enabled to edit the regular expression table. Be careful when giving out this permission, incorrect regular expressions can be very harmful (infinite loops, loss of data, etc.).</li>
		<li><b>Perm tagger:</b> Allows the user with this permission to create custom tags and assign them to events. </li>
	</ul>
