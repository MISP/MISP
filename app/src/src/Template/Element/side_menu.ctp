<div class="actions <?php echo $debugMode;?> sideMenu">
	<ul class="nav nav-list">
		...
		<?php
					...
					<li><?php echo $this->Form->postLink('Delete Event', array('action' => 'delete', h($event['Event']['id'])), null, __('Are you sure you want to delete # {0}?', h($event['Event']['id']))); ?></li>
				...
				case 'regexp': ?>
					...
					<li><?php echo $this->Form->postLink('Delete Regexp', array('admin' => true, 'action' => 'delete', h($id)), null, __('Are you sure you want to delete # {0}?', h($id)));?></li>
					<?php
					endif;
				break;
				case 'warninglist':?>
				...
				case 'whitelist':?>
					...
					<li><?php echo $this->Form->postLink('Delete Whitelist', array('admin' => true, 'action' => 'delete', h($id)), null, __('Are you sure you want to delete # {0}?', h($id)));?></li>
					<?php
					endif;
				break;
				...
				case 'sync':
					...
					<li><?php echo $this->Form->postLink('Delete', array('action' => 'delete', $this->Form->value('Server.id')), null, __('Are you sure you want to delete # {0}?', $this->Form->value('Server.id'))); ?></li>
					<li class="divider"></li>
					<?php endif; ?>
				...
				case 'admin':
					...
					<li><?php echo $this->Form->postLink('Delete User', array('admin' => true, 'action' => 'delete', h($id)), null, __('Are you sure you want to delete # {0}? It is highly recommended to never delete users but to disable them instead.', h($id)));?></li>
					<li class="divider"></li>
					<?php endif;
					...
					<li><?php echo $this->Form->postLink('Delete Role', array('controller' => 'roles', 'admin' => true, 'action' => 'delete', h($id)), null, __('Are you sure you want to delete # {0}?', h($id)));?></li>
					<li class="divider"></li>
					<?php endif;
					if ($isSiteAdmin): ?>
