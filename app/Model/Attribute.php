...
class Attribute extends AppModel {
	...
	public $typeDefinitions = array(
			...
			'cookie-name' => array('desc' => 'HTTP cookie as often stored on the user web client. This type contains the "name" part of the cookie. This can include authentication cookie or session cookie.', 'default_category' => 'Network activity', 'to_ids' => 0),
			'cookie-value' => array('desc' => 'HTTP cookie as often stored on the user web client. This type contains the "value" part of the cookie.This can include authentication cookie or session cookie.', 'default_category' => 'Network activity', 'to_ids' => 0),
	...
	public $categoryDefinitions = array(
			...
			'Network activity' => array(
					...
					'types' => array('ip-src', 'ip-dst', 'ip-dst|port', 'ip-src|port', 'hostname', 'domain', 'domain|ip', 'email-dst', 'url', 'uri', 'user-agent', 'http-method', 'AS', 'snort', 'pattern-in-file', 'pattern-in-traffic', 'attachment', 'comment', 'text', 'x509-fingerprint-sha1', 'other', 'hex', 'cookie-name', 'cookie-value')
					),
			'Payload type' => array(
