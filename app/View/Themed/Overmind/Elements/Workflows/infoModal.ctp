<?php
/*
 * Bootstrap 5 copy of the workflow editor help modal.
 */
?>
<div id="workflow-info-modal" class="modal fade" tabindex="-1" aria-labelledby="workflow-info-modal-label" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title fw-bold" id="workflow-info-modal-label"><?= __('Workflows documentation & concepts') ?></h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?= __('Close') ?>"></button>
        </div>
    <div class="modal-body">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#modal-info-concept" type="button" role="tab"><?= __('Terminology & Concepts') ?></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#modal-hash-path" type="button" role="tab"><?= __('Hash Path') ?></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#modal-core-format" type="button" role="tab"><?= __('MISP Core Format') ?></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#modal-jinja2" type="button" role="tab"><?= __('Jinja2 Syntax') ?></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#modal-misp-module-results" type="button" role="tab"><?= __('misp-modules results') ?></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#modal-blueprint" type="button" role="tab"><?= __('Blueprints') ?></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#modal-debugging" type="button" role="tab"><?= __('Debugging') ?></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#modal-info-usage" type="button" role="tab"><?= __('Usage & Shortcuts') ?></button>
            </li>
        </ul>
