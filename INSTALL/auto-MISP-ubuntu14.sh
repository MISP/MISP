utosnort script for Ubuntu 12.04+
########################################
...
if (( $size < 6 ));
then
        echo -e "\x1B[01;33mPassword is too short - $size, please consider choosing a longer password\x1B[0m"
fi

echo "Please enter your mysql MISP password:"
read misp_mysql_pass
