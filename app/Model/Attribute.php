    ...
    public function __construct($id = false, $table = null, $ds = null) {
        ...
        $this->categoryDefinitions = array(
            ...
            'Persistence mechanism' => array(
                    ...
                    'types' => array('filename', 'service-name', 'scheduled-task-name', 'regkey', 'regkey|value', 'comment', 'text', 'other', 'hex', 'anonymised')
                    ),
        ...
        $this->typeDefinitions = array(
            ...
            'service-name' => array('desc' => __('Service name used for persistence'), 'default_category' => 'Persistence mechanism', 'to_ids' => 0),
            'scheduled-task-name' => array('desc' => __('Scheduled task name used for persistence'), 'default_category' => 'Persistence mechanism', 'to_ids' => 0),
