...
class IOCExportTool
{
    ...
    public function generateSingleTop($event)
    {
        ...
        $temp .= '    <Indicator operator="OR" id="' . Text::uuid() . '">' . PHP_EOL;
        return $temp;
    }
    ...
    public function generateTop($user)
    {
        ...
        $temp .= '<?xml version="1.0" encoding="utf-8"?>' . PHP_EOL;
        $temp .= '<ioc xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" id="' . Text::uuid() . '" last-modified="' . $date . '" xmlns="http://schemas.mandiant.com/2010/ioc">' . PHP_EOL;
