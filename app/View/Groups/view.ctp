...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Autoalert'); ?></th>
		<th><?php echo __('Authkey'); ?></th>
		<th><?php echo __('Invited By'); ?></th>
		<th><?php echo __('Gpgkey'); ?></th>
		<th><?php echo __('Nids Sid'); ?></th>
		<th><?php echo __('Termsaccepted'); ?></th>
		<th><?php echo __('Newsread'); ?></th>
	...
	<?php
		...
		<tr>
			...
			<td><?php echo $user['gpgkey'];?></td>
			<td><?php echo $user['nids_sid'];?></td>
			<td><?php echo $user['termsaccepted'];?></td>
			<td><?php echo $user['newsread'];?></td>
