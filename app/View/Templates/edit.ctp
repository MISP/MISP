				...
				<table>
					<tr>
						...
						<td id = "addTagButtonTD">
							<span role="button" tabindex="0" aria-label="<?php echo __('Add tag');?>" title="<?php echo __('Add tag');?>" onClick="activateTagField()" id="addTagButton" class="btn btn-dark noPrint" style="line-height:10px; padding: 4px 4px;">+</span>
						</td>
						<td id = "addTagFieldTD">
							<?php
