...
<div class="row-fluid">
	...
	<br />
	<?php if ($local): ?>
		<button id="button_description" class="btn btn-dark toggle-left qet orgViewButton" onClick="organisationViewContent('description', '<?php echo $id;?>');"><?php echo __('Description');?></button>
		...
		<?php if ($fullAccess): ?>
			<button id="button_members" class="btn btn-dark toggle qet orgViewButton" onClick="organisationViewContent('members', '<?php echo $id;?>');"><?php echo __('Members');?></button>
		...
		<button id="button_events" class="btn btn-dark toggle-right qet orgViewButton" onClick="organisationViewContent('events', '<?php echo $id;?>');"><?php echo __('Events');?></button>
