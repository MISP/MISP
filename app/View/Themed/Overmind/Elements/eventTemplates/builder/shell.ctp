...
<div class= "container-fluid eventTemplates builder px-4 py-4"
     x-data="etBuilder" x-cloak>
    <div class= <?= $isModal ? 'px-2' : '' ?>>
        ...
        <div class="d-flex flex-column gap-4 mb-4 et-envelope">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <div class="w-100">
                        <?php
                        echo $this->element('genericElementsBS5/Forms/distribution_field', [
                            'accent' => 'primary',
                            'levels' => $distributionLevels,
                            'value' => $envelope['distribution'],
                            'compact' => true,
                            'id' => 'et-envelope-distribution',
                            'selectAttrs' => [
                        ...
                        <div class="et-canvas" id="et-canvas" style="min-height:420px;">
                            ...
                            <template x-for="el in definition.structure" :key="el.id">
                                <div class="et-canvas-element"
                                    ...
                                    <div class="et-element-errors alert alert-danger py-1 mt-2 mb-0 small"
                                        x-show="errorsForElement(el.id).length">
                                        <ul class="mb-0 ps-3">
