<?php
$eventid = 2;
$warninglist_hits = $warningslist_hits = [["value" => "8.8.8.8","match" => "8.8.8.8/32","warninglist_id" => 49,"warninglist_name" => "List of known IPv4 public DNS resolvers","warninglist_category" => "false_positive"]];
$recent_sightings = [
        ...
        <div class="stat-panel-md2">
            ...
            $countsHtml = $this->Bootstrap->render(
                ...
                [
                    ...
                    'iocs_percentage' => 0, //sprintf('%s%%', round(100 * $stats['stat_counts']['iocs'] / $stats['stat_counts']['attributes'])),
