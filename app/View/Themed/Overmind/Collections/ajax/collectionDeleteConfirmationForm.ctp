    ...
    <div class="card shadow-sm d-inline-block w-auto">
        <div class="card-header">
            <h4 class="card-title mb-2 mt-2">
                <?php echo __('Collection Deletion'); ?>
            </h4>
        </div>
        ...
        <div class="card-body">
            ...
            <?php
                if (count($idArray) > 1) {
                    $message = __('Are you sure you want to delete %s collections ?', count($idArray));
                } else {
                    $message = __('Are you sure you want to delete collection #%s ?', $idArray[0]);
                }
            ?>
