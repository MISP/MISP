		...
		<td class="membersList-histogram-left-table">
			...
			?>
				<tr>
					...
					?>
						<li title="<?php echo $orgType . ' : ' . $orgTypeCount; ?>" class="type_<?php echo $orgType; ?>" style="display:block;height:30px;float:left;width:<?php echo (100 * $orgTypeCount / $org['total']);?>%;background:<?php echo $typeDb[$orgType];?>">&nbsp;</li>
						<?php endforeach;?>
						</ul>
					</td>
