...
foreach ($list as $item):?>
    <tr>
        ...
        <td class="short action-links">
            <?php echo $this->Form->postLink('', array('action' => 'delete', $item['Galaxy']['id']), array('class' => 'fa fa-trash', 'title' => __('Delete')), sprintf(__('Are you sure you want to delete the Galaxy (%s)?'), $item['Galaxy']['name'])); ?>
            <?php echo $this->Html->link('', array('action' => 'view', $item['Galaxy']['id']), array('class' => 'fa fa-eye', 'title' => __('View')));?>
        </td>
    </tr><?php
endforeach;?>
    </table>
