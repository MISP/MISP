...
class EventsController extends AppController
{
    ...
    public function exportChoice($id)
    {
        ...
        $exports = array(
            ...
            'openIOC' => array(
                    'url' => $this->baseurl . '/events/downloadOpenIOCEvent/download/' . $id,
                    'text' => 'OpenIOC (all indicators marked to IDS)',
                    'requiresPublished' => false,
                    'checkbox' => false,
            ),
            'csv' => array(
                    'url' => $this->baseurl . '/events/csv/download/' . $id,
                    'text' => 'CSV',
                    'requiresPublished' => false,
                    'checkbox' => true,
                    'checkbox_text' => 'Include non-IDS marked attributes',
                    'checkbox_set' => $this->baseurl . '/events/csv/download/' . $id . '/1'
            ),
            'csv_with_context' => array(
                    'url' => $this->baseurl . '/events/restSearch/returnFormat:csv/eventid:' . $id,
                    'text' => 'CSV with additional context',
                    'requiresPublished' => false,
                    'checkbox' => true,
                    'checkbox_text' => 'Include non-IDS marked attributes',
                    'checkbox_set' => $this->baseurl . '/events/restSearch/returnFormat:csv/to_ids:1||0/published:1||0/eventid:' . $id
            ),
            'stix_xml' => array(
            ...
            'stix_json' => array(
                    'url' => $this->baseurl . '/events/restSearch/stix/eventid:' . $id . '.json',
                    'text' => 'STIX JSON (metadata + all attributes)',
                    'requiresPublished' => false,
                    'checkbox' => true,
                    'checkbox_text' => 'Encode Attachments',
                    'checkbox_set' => $this->baseurl . '/events/restSearch/stix/withAttachments:1/eventid:' . $id . '.json'
            ),
            'stix2_json' => array(
        ...
        if ($event['Event']['published'] == 0) {
            ...
            $exports['csv'] = array(
                'url' => $this->baseurl . '/events/csv/download/' . $id . '/1',
