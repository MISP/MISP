<div class="index">
    <div style="padding: 1em 2em; margin-bottom: 2em;">
        ...
        <p>This JSON can be added to the <code class="quickSelect">misp-galaxy/clusters/<?= h($cluster['GalaxyCluster']['type']) ?>.json</code>.</p>
        ...
        <pre class="quickSelect"><?= json_encode(h($convertedCluster), true) ?></pre>
    </div>
</div>
