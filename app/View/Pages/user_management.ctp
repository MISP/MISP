<div class="index">
	...
	<ul>
		...
		<p><img src="/img/doc/add_server.png" alt = "" title="Changing the password"></p><br></li>
		...
		<p><img src="/img/doc/bottom_bar.png" alt = "" title="Click on PGP/GPG key to download the key."></p><br /></li>
		...
		<p><img src="/img/doc/" alt = "" title="Tick this checkbox to enable auto-alerts."></p><br></li>
		<li><em>Reviewing the Terms &amp; Conditions:</em> To review the Terms &amp; Conditions or to use the User Guide, use the appropriate button on the left navigation menu.<br /><br></li>
...
<ul>
	<li style="list-style: none">
		<p><img src="/img/doc/my_profile.png" alt = "" style="float:right;" title="Change any of your profile settings here."></p><br>
	</li>
	...
	<li><em>Requesting a new authentication key:</em> It is possible to make the system generate a new authentication key for you (for example if your previous one gets compromised. This can be accessed by clicking on the My Profile button and then clicking the reset key next to the currently active authentication code. The old code will become invalid when the new key is generated.<br><br>
