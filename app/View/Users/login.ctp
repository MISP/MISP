...
<table style="width:1200px;margin-left:auto;margin-right:auto;">
	...
	<td style="text-align:right;width:250px;padding-right:50px">
		<?php if (Configure::read('MISP.welcome_logo')) echo $this->Html->image('custom/' . Configure::read('MISP.welcome_logo'), array('alt' => 'Logo', 'onerror' => "this.style.display='none';")); ?>
	</td>
	...
	<td style="width:250px;padding-left:50px">
		<?php if (Configure::read('MISP.welcome_logo2')) echo $this->Html->image('custom/' . Configure::read('MISP.welcome_logo2'), array('alt' => 'Logo2', 'onerror' => "this.style.display='none';")); ?>
	</td>
	</tr>
	</table>
</div>
